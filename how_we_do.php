                                                                ...
                                                                <ul>
                                                                    <li><h3 class="accordion_header">Engaging Business & Content</h3>
                                                                        <div class="accordion_detail">
                                                                            <p> Development is designed to engage employees, facilitate learning and improves performance through interactive, rich-media delivery and user-enabled customization. On-demand customization options – add video, graphics and training points to make content solution specific. Incorporates sound instructional design based on the ADDIE (Analysis, Design, Development, Implementation, Evaluation) model to ensure training to the learning objective Courseware are branded with your organization's need for relevance. This model strives to save time and money by catching problems while they are still easy to fix.</p>
                                                                        </div>
                                                                    </li>
                                                                    <li><h3 class="accordion_header">Designing a Scalable Applications</h3>
                                                                        <div class="accordion_detail">
                                                                            <p> In electronics (including hardware, communication and software), scalability is the ability of a system, network, or process to handle a growing amount of work in a capable manner. It is often advised to focus system design on hardware scalability rather than on capacity.</p><br>
                                                                    ...
                                                                    <li><h3 class="accordion_header">Professional Services</h3>
                                                                        <div class="accordion_detail">
                                                                            <p>
                                                                                <ul>
